# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2018-09-29 11:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon_type', models.SmallIntegerField(choices=[(0, '立减券'), (2, '满减券'), (3, '折扣券')], default=0, verbose_name='优惠券类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.SmallIntegerField(choices=[(0, '未使用'), (1, '已使用'), (2, '已过期')], default=0, verbose_name='优惠券使用状态')),
                ('get_time', models.DateTimeField(help_text='用户领取时间', verbose_name='优惠券领取时间')),
                ('used_time', models.DateTimeField(blank=True, null=True, verbose_name='优惠券使用时间')),
                ('order_id', models.IntegerField(blank=True, null=True, verbose_name='关联订单ID')),
                ('coupon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Coupon', verbose_name='优惠券生成规则')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.User', verbose_name='优惠券的拥有者')),
            ],
            options={
                'verbose_name': '优惠券记录',
